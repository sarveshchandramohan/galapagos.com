...
<header class="header">
   ...
   <a class="logo"><img src="img/icon.webp" style= "width:200px; height:250px; border-radius:30%; alt="logo"></a>
   </div>
        <div class="col-md-12 text-center">
...
<section id="aboutus">
 ...
 <div class="container">
   <h3 class="text-center"><br><br>Galapagos</h3>
   <div class="row">
<!--carousel-->
...
<!--end of carousel-->
	...
	<p><br>The restaurant <strong>Galapagos</strong>, first opened in 2022 in “Chennai”, one of the oldest and famous district of Tamilnadu in the tourist center of the city. In 2023, our restaurant was promoted to 5<em>star</em> accredation by the tamilnadu Government.<br><br>
	The last year, the restaurant was redesigned by well trained members.  Now it looks perfectly awesome.  A peaceful environment to take a short brake in your rough life.  <br><br><br></p><hr>
	</div>
     </div>
    </div><br>
  </div>
...
?>
            ...
            <p class="text-right">Galapagos<br><i class="fa fa-map-marker"></i>&nbsp;Chennai Institute of Technology <br>Tamil Nadu <br><br>email:hotelreservation005@gmail.com<br>phone:+91 6385634755</p>
            </div>
